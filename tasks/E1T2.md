# E1T2 — Validate text size and mode choice

**Weight:** 0.0000 (share of project budget)
**Reward:** 0 EPTX

Ensure messages do not exceed 10,000 characters. Prompt users to select 'first-read' or 'time-limited' expiration mode.
