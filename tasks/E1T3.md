# E1T3 — Enforce rate limits and content policy

**Weight:** 0.0000 (share of project budget)
**Reward:** 0 EPTX

Implement rate limiting (10 uploads/hour per hashed Telegram sender ID). Add basic spam heuristics to reject abusive content.
