# E1T1 — Handle /upload command

**Weight:** 0.0000 (share of project budget)
**Reward:** 0 EPTX

Add a /upload command that accepts text input. Write a BotSpec JSON array to tests/specs/E1T1.json and append the command to tests/commands.json.
