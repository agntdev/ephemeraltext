# E3T1 — Implement first-read expiration

**Weight:** 0.0000 (share of project budget)
**Reward:** 0 EPTX

Delete the encrypted payload immediately after the first successful read. Show a one-time-view notice on the web frontend.
