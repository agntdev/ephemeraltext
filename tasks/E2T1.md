# E2T1 — Encrypt message payload with per-message data key

**Weight:** 0.0000 (share of project budget)
**Reward:** 0 EPTX

Encrypt user-submitted text with a unique data key per message. Store the encrypted payload in the database.
