# E1T4 — Generate encrypted shareable link

**Weight:** 0.0000 (share of project budget)
**Reward:** 0 EPTX

Create a URL like https://example.com/r/<public_token> using a 132-bit entropy token. Write a BotSpec JSON array to tests/specs/E1T4.json and append the command to tests/commands.json.
