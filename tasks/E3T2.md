# E3T2 — Implement time-limited expiration

**Weight:** 0.0000 (share of project budget)
**Reward:** 0 EPTX

Allow users to set a time-based expiry (up to 7 days). Keep the message until expires_at, incrementing read_count on each view.
