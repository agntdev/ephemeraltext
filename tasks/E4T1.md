# E4T1 — Create admin interface for moderation

**Weight:** 0.0000 (share of project budget)
**Reward:** 0 EPTX

Add a /admin command for admins to search logs, delete messages, or view metrics. Write a BotSpec JSON array to tests/specs/E4T1.json and append the command to tests/commands.json.
