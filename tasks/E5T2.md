# E5T2 — Hash Telegram sender IDs for anonymity

**Weight:** 0.0000 (share of project budget)
**Reward:** 0 EPTX

Hash sender IDs using HMAC with a server key for rate-limiting and audit logs. Ensure the hash is non-reversible.
